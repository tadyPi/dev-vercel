    ...
    return (
        <section className="relative flex flex-col ml-0 lg:ml-32 px-24 py-16 max-md:px-10 max-sm:px-5" aria-labelledby="hero-title">
            ...
            <div className="flex flex-col relative top-26 sm:top-35 lg:top-20 gap-8 max-w-[878px]">
                ...
                <div className="flex gap-2 w-[60%] sm:w-[50%] lg:w-[42%] rounded-md p-1 items-center bg-gradient-to-b from-zinc-50/10 to-indigo-600/50 border border-zinc-50/10 start-up">
                    ...
                    <span className="text-sm lg:text-lg p-2 font-light rounded-md text-stone-300">
                        UI/UX design and Figma designer.
                    </span>
                </div>
                {/* Blurred fade in */}
                <div className="flex flex-col gap-5">
                    ...
                    <p className="text-base lg:text-lg text-zinc-300/80 font-light max-md:text-xl max-sm:text-base">
                        Using <span className="text-[#e6e6e6] text-base font-semibold lg:text-xl lg:font-medium">Google UX design principles</span> and <span className="text-[#f45451fb] text-base font-semibold lg:text-xl lg:font-medium">Figma</span> design tools to <span className="font-semibold text-indigo-400">Design and Developer</span> custom web apps.
                    </p>
                    <p className="text-base lg:text-lg text-zinc-300/80 font-light max-md:text-xl max-sm:text-base">
                        Our approach to web design is characterized by a dynamic fusion of cutting-edge tools and technologies to craft responsive websites and web applications that stand out in the digital landscape.
                    </p>
                </div>
