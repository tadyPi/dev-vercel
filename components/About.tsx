...
const About: React.FC/*<AboutProps>*/ = (/*{ onGetInTouch }*/) => {
    return (
        <section className="w-full flex gap-2 md:gap-0 lg:gap-8 xl:gap-32 px-6 md:px-4 lg:px-12 xl:px-40 lg:pb-28 items-center max-md:flex-col max-md:gap-2" aria-labelledby="about-title">
            <img src="https://cdn.builder.io/api/v1/image/assets/TEMP/99280f9bf1ffc06da3c6a119c705d9003382dcd5" alt="About Load of Pixels" className="w-full md:w-[50%] md:h-[50%] mt-4 border-none h-auto" />
            <div className="flex flex-col gap-14 max-w-[701px]">
                <div className="flex flex-col sm:mt-9 lg:mt-20 gap-10">
                    ...
                    <h2 id="about-title" className="text-[3.2em] leading-tight max-md:text-5xl max-sm:text-3xl">
                        ...
                        <span className="text-indigo-700">meticulous design process!</span>
                    </h2>
                    <p className="text-2xl lg:text-lg text-zinc-300 max-w-full">
                        Delivering high-quality web development, with on-demand UX
                        design with accessibility and precision.<br />
                        <br />
                        Elevate your brand
                        effortlessly, with design and development from <span className="sm:text-3xl lg:text-lg text-indigo-600">Load of Pixels</span>.
                    </p>
                </div>
                <div className="flex flex-col gap-4 max-w-full">
                    <div className="flex gap-3.5 items-center">
                        <img src="/Icon-Container.png" alt="" className="w-[35.151px] h-[35.667px]" aria-hidden="true" />
                        <span className="text-sm sm:text-xl lg:text-base text-white">Web Development and Cloud Services.</span>
                    </div>
                    <div className="flex gap-3.5 items-center">
                        <img src="/Icon-Container.png" alt="" className="w-[35.151px] h-[35.667px]" aria-hidden="true" />
                        <span className="text-sm sm:text-xl lg:text-base text-white">Google UX Design.</span>
                    </div>
                    <div className="flex gap-3.5 items-center">
                        <img src="/Icon-Container.png" alt="" className="w-[35.151px] h-[35.667px]" aria-hidden="true" />
                        <span className="text-sm sm:text-xl lg:text-base text-white">Figma Designer.</span>
                    </div>
                </div>
                <div className="flex gap-16 items-center max-sm:flex-col max-sm:gap-8">
                    <button
                        className="px-4 py-3 text-lg text-gray-200 bg-indigo-600 rounded-2xl
