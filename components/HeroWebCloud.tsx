    ...
    return (
        <section className="relative flex flex-col ml-0 lg:ml-32 px-24 py-16 max-md:px-10 max-sm:px-5" aria-labelledby="hero-title">
            ...
            <div className="flex flex-col relative top-26 sm:top-35 lg:top-20 gap-8 max-w-[878px]">
                ...
                <div className="flex gap-2 w-[60%] sm:w-[50%] lg:w-[45%] rounded-md p-1 items-center bg-gradient-to-b from-zinc-50/10 to-indigo-600/50 border border-zinc-50/10 start-up">
                ...
                <div className="flex flex-col gap-5">
                    <h2 id="hero-title" className="text-[5.5em] leading-none text-white max-md:text-7xl max-sm:text-[2.7em] gradient-text">
                        Cloud Services and Cloud Native apps.
                    </h2>
                    {/* Transparency Reveal */}
                    <p className="text-base lg:text-lg text-zinc-300/80 font-light max-md:text-xl max-sm:text-base">
                        We are committed to delivering high-quality cloud solutions that meet the needs of our clients.
                    </p>
                    <p className="text-base lg:text-lg text-zinc-300/80 font-light max-md:text-xl max-sm:text-base">
                        Our team of experts is dedicated to providing exceptional service and support, ensuring that our clients can leverage the full potential of cloud technology.
                    </p>
                </div>
