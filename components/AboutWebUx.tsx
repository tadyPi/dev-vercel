...
const AboutWebUx: React.FC/*<AboutProps>*/ = (/*{ onGetInTouch }*/) => {
    return (
        <section className="flex gap-2 lg:gap-32 px-6 lg:px-40 lg:pb-28 items-center max-md:flex-col max-md:gap-2" aria-labelledby="about-title">
            ...
            <div className="flex flex-col gap-7 max-w-[701px]">
                <div className="flex flex-col sm:mt-9 lg:mt-20 gap-6">
                    ...
                    <h2 id="about-title" className="text-white text-[2.72em] leading-tight max-sm:text-3xl">I embrace equity-focused design, Creating inclusive experiences that can be enjoyed by a diverse range of users.</h2>
                    {/*  */}
                    <p className="text-base sm:text-3xl lg:text-lg text-zinc-300 max-w-full">
                        At the core of our design process, we harness the power of industry-leading design platform: Figma. The versatility of Figma design tools allow us to conceptualize, prototype, and refine our designs with precision and efficiency.
                    </p>
                </div>
