...
import HeroWebCloud from '@/components/HeroWebCloud';
import AboutWebCloud from '@/components/AboutWebCloud';
...
const CloudServices: React.FC = () => {
    ...
    return (
        <div className="flex flex-col bg-black min-h-screen">
            ...
            <main>
                <HeroWebCloud /*onConnectWithUs={handleConnectWithUs}*/ />
                <AboutWebCloud /*onGetInTouch={handleGetInTouch}*/ />
                <Features />
                <FAQ />
